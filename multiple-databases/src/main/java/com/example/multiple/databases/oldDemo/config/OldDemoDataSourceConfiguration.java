package com.example.multiple.databases.oldDemo.config;
...
@EnableJpaRepositories(
        ...
        basePackages = {"com.example.multiple.databases.oldDemo.repository"}
)
public class OldDemoDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean oldDemoEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.example.multiple.databases.oldDemo.entity")
